...
<<<<<<< HEAD
#define CREATE_FUNC2(__TYPE_NAME__) static __TYPE_NAME__ *create() { \
...
#define CREATE_FUNC3(__TYPE_NAME__) __TYPE_NAME__() {};\
 ~__TYPE_NAME__() {};\
...
=======
#define CLASS_BASE(__TYPE_NAME__) __TYPE_NAME__() {}; ~__TYPE_NAME__() {};
